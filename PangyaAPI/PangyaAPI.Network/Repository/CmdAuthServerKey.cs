...
namespace PangyaAPI.Network.Repository
{
    public class CmdAuthServerKey : Pangya_DB
    {
        ...
        protected override Response prepareConsulta()
        {
            ...
            var r = consulta($"SELECT server_uid, {makeEscapeKeyword("key")}, VALID " +
                             $"FROM pangya.pangya_auth_key " +
                             $"WHERE server_uid = {m_server_uid.ToString(System.Globalization.CultureInfo.InvariantCulture)}");
